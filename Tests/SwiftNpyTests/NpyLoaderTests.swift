...
class NpyLoaderTests: XCTestCase {
    ...
    func testLoadFloatDouble() {
        do {
            let npy: Npy = try! Npy(data: f2)
            XCTAssertEqual(npy.shape, [1, 1, 6])
            let elements: [Float16] = npy.elements()
            XCTAssertEqual(elements, [-3, -2, -1, 0, 1, 2])
        }
        do {
...
/// [[[-3, -2, -1,  0.,  1,  2]]]
let f2 = Data(bytes: [
    0x93, 0x4e, 0x55, 0x4d, 0x50, 0x59, 0x01, 0x00, 0x3f, 0x00, 0x7b, 0x20, 0x27, 0x64, 0x65, 0x73,
    0x63, 0x72, 0x27, 0x3a, 0x20, 0x27, 0x3d, 0x66, 0x32, 0x27, 0x2c, 0x20, 0x27, 0x66, 0x6f, 0x72,
    0x74, 0x72, 0x61, 0x6e, 0x5f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x27, 0x3a, 0x20, 0x46, 0x61, 0x6c, 
    0x73, 0x65, 0x2c, 0x20, 0x27, 0x73, 0x68, 0x61, 0x70, 0x65, 0x27, 0x3a, 0x20, 0x28, 0x31, 0x2c,
    0x20, 0x31, 0x2c, 0x20, 0x36, 0x29, 0x2c, 0x20, 0x7d, 0x00, 0xc2, 0x00, 0xc0, 0x00, 0xbc, 0x00,
    0x00, 0x00, 0x3c, 0x00, 0x40
])
